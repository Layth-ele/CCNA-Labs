...
| 07 | [Access Control Lists](07-acl/) | Extended ACLs, permit/deny, implicit deny, direction & placement |

## Reference

- [COMMANDS.md](COMMANDS.md) — command cheat sheet for all labs.

## Roadmap

Planned: VLAN trunking across switches, EtherChannel, Spanning Tree, port
security, SSH/device hardening, IPv6, wireless.
